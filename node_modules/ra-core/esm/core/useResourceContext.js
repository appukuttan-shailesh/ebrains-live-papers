...
export var useResourceContext = function (props) {
    ...
    if (!context) {
        ...
        if (process.env.NODE_ENV !== 'production') {
            console.warn("Any react-admin components must be used inside a <ResourceContextProvider>. Relying on props rather than context to get the resource data is deprecated and won't be supported in the next major version of react-admin.");
        }
