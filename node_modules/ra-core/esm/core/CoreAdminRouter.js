...
var CoreAdminRouter = function (props) {
    ...
    var layout = props.layout, catchAll = props.catchAll, children = props.children, customRoutes = props.customRoutes, dashboard = props.dashboard, loading = props.loading, logout = props.logout, menu = props.menu, ready = props.ready, theme = props.theme, title = props.title;
