      ...
      <div>
        ...
        <div className="block">
          ...
          <div className="block-text">
            ...
            <div style={{ textAlign: "center" }}>
              <img src="/figures/share_common/lp_resource_toolbar.png" width="85%" />
            </div>
            <br />
            ...
            <br /><br />
            <div style={{ textAlign: "center" }}>
              <img src="/figures/share_common/resource_example_new.png" width="85%" />
            </div>
          </div>
        </div>
        ...
        <div className="block">
          ...
          <div className="block-text">
            ...
            <br /><br />
            <div style={{ textAlign: "center" }}>
              <img src="/figures/share_common/resource_title_bar_marked.png" width="85%" />
            </div>
            <br />
          </div>
        </div>
        ...
        <div className="block">
          ...
          <div className="block-text">
            ...
            <br /><br />
            <div style={{ textAlign: "center" }}>
              <img src="/figures/share_common/resource_add_row.png" width="85%" />
            </div>
            <br />
            ...
            <br /><br />
            <div style={{ textAlign: "center" }}>
              <img src="/figures/share_common/resource_add_row_enter.png" width="85%" />
            </div>
            <br />
          </div>
        </div>
        ...
        <div className="block">
          ...
          <div className="block-text">
            ...
            <br /><br />
            <div style={{ textAlign: "center" }}>
              <img src="/figures/share_common/resource_add_from_db.png" width="85%" />
            </div>
            <br />
            ...
            <br /><br />
            <div style={{ textAlign: "center" }}>
              <img src="/figures/share_common/resource_add_from_db_repos.png" width="50%" />
            </div>
            <br />
            ...
            <br /><br />
            <div style={{ textAlign: "center" }}>
              <img src="/figures/share_common/resource_add_from_db_repos_expand.png" width="85%" />
            </div>
            <br />
            ...
            <br /><br />
            <div style={{ textAlign: "center" }}>
              <img src="/figures/share_common/resource_add_from_db_repos_done.png" width="85%" />
            </div>
            <br />
            ...
            <br /><br />
            <div style={{ textAlign: "center" }}>
              <img src="/figures/share_common/resource_add_from_db_repos_added.png" width="85%" />
            </div>
            <br />
          </div>
        </div>
        ...
        <div className="block">
          ...
          <div className="block-text">
            ...
            <br /><br />
            <div style={{ textAlign: "center" }}>
              <img src="/figures/share_common/resource_expand_table.png" width="85%" />
            </div>
            <br />
            ...
            <br /><br />
            <div style={{ textAlign: "center" }}>
              <img src="/figures/share_common/resource_add_from_db_repos_expand_show.png" width="85%" />
            </div>
            <br />
          </div>
        </div>
        ...
        <div className="block">
          ...
          <div className="block-text">
            ...
            <br /><br />
            <div style={{ textAlign: "center" }}>
              <img src="/figures/share_common/resource_order_delete.png" width="85%" />
            </div>
            <br />
          </div>
        </div>
        ...
        <div className="block">
          ...
          <div className="block-text">
            ...
            <br /><br />
            <div style={{ textAlign: "center" }}>
              <img src="/figures/share_common/resource_edit_source.png" width="85%" />
            </div>
            <br />
            ...
            <br /><br />
            <div style={{ textAlign: "center" }}>
              <img src="/figures/share_common/resource_edit_panel.png" width="85%" />
            </div>
            <br />
          </div>
        </div>
        ...
        <div className="block">
          ...
          <div className="block-text">
            ...
            <br /><br />
            <div style={{ textAlign: "center" }}>
              <img src="/figures/share_common/resource_use_tabs.png" width="85%" />
            </div>
            <br />
            ...
            <br /><br />
            <div style={{ textAlign: "center" }}>
              <img src="/figures/share_common/resource_use_tabs_column.png" width="85%" />
            </div>
            <br />
            ...
            <br /><br />
            <div style={{ textAlign: "center" }}>
              <img src="/figures/share_common/resource_use_tabs_enter.png" width="85%" />
            </div>
            <br />
            ...
            <br /><br />
            <div style={{ textAlign: "center" }}>
              <img src="/figures/share_common/resource_use_tabs_enter_demo.png" width="85%" />
            </div>
            <br />
