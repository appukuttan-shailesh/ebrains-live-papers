        ...
        <div className="block">
          ...
          <div className="block-text">
            ...
            <div style={{ lineHeight: 1.75 }}>
              <ul>
                <li><a href onClick={() => this.changeTime(100)}>Introduction to Live Papers</a></li>
                <li>
                  <a href onClick={() => this.changeTime(500)}>Live Paper Platform</a>
                  <ul>
                    <li><a href onClick={() => this.changeTime(600)}>Listing of all Live Papers</a></li>
                    <li><a href onClick={() => this.changeTime(600)}>Walkthrough a sample Live Paper</a></li>
                  </ul>
                </li>
                <li>
                  ...
                  <ul>
                    <li>
                      ...
                      <ul>
                        <li><a href onClick={() => this.changeTime(600)}>Loading metadata via DOI</a></li>
                        <li><a href onClick={() => this.changeTime(600)}>Loading metadata via PDF</a></li>
                        <li><a href onClick={() => this.changeTime(600)}>Entering/updating metadata manually</a></li>
                    ...
                    <li>
                      ...
                      <ul>
                        ...
                        <li>
                          ...
                          <ul>
                            <li><a href onClick={() => this.changeTime(600)}>Adding entries to section</a></li>
                            <li><a href onClick={() => this.changeTime(600)}>Expanding input area</a></li>
                            <li><a href onClick={() => this.changeTime(600)}>Re-ordering entries in section</a></li>
                            <li><a href onClick={() => this.changeTime(600)}>Grouping items into tabs</a></li>
                            <li>
                              <a href onClick={() => this.changeTime(600)}>Editing source code</a>
                              <ul>
                                <li><a href onClick={() => this.changeTime(600)}>Simple multi-input tool</a></li>
                              </ul>
                            </li>
                            <li><a href onClick={() => this.changeTime(600)}>Re-ordering live paper sections</a></li>
                            <li><a href onClick={() => this.changeTime(600)}>Collapsing a live paper section</a></li>
                        ...
                        <li>
                          ...
                          <ul>
                            <li><a href onClick={() => this.changeTime(600)}>Add from external database</a></li>
                          </ul>
                        </li>
                        <li>
                          <a href onClick={() => this.changeTime(600)}>Electrophysiology section</a>
                          <ul>
                            <li><a href onClick={() => this.changeTime(600)}>Add from external database</a></li>
                          </ul>
                        </li>
                        <li>
                          <a href onClick={() => this.changeTime(600)}>Models section</a>
                          <ul>
                            <li><a href onClick={() => this.changeTime(600)}>Add from external database</a></li>
                          </ul>
                        </li>
                        <li>
                          <a href onClick={() => this.changeTime(600)}>Custom HTML/Markdown section</a>
                          <ul>
