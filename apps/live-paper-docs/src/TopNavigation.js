      ...
      >
        <div style={{ display: "flex", justifyContent: "space-around" }}>
          <span
            className={
              "nav-item-style" +
              (this.props.pageOpen === "" ? " nav-item-active-style" : "")
            }
            style={{ marginRight: "20px" }}
            onClick={() => this.props.updateHash("")}
          >
            Introduction
          </span>
          <span
            className={
              "nav-item-style" +
              (this.props.pageOpen === "find" ? " nav-item-active-style" : "")
            }
            style={{ marginRight: "20px" }}
            onClick={() => this.props.updateHash("find")}
          >
            Find
          </span>
          <span
            className={
              "nav-item-style" +
              (this.props.pageOpen === "create" ? " nav-item-active-style" : "")
            }
            style={{ marginRight: "20px" }}
            onClick={() => this.props.updateHash("create")}
          >
            Create
          </span>
          ...
          <span
            className={
              "nav-item-style" +
              (this.props.pageOpen === "develop"
                ? " nav-item-active-style"
                : "")
            }
            style={{ marginRight: "20px" }}
            onClick={() => this.props.updateHash("develop")}
          >
            Develop
          </span>
          <span
            className={
              "nav-item-style" +
              (this.props.pageOpen === "tutorial"
                ? " nav-item-active-style"
                : "")
            }
            onClick={() => this.props.updateHash("tutorial")}
          >
            Tutorial
          </span>
          <span
            className={
              "nav-item-style" +
              (this.props.pageOpen === "credits"
                ? " nav-item-active-style"
                : "")
            }
            onClick={() => this.props.updateHash("credits")}
          >
            Credits
          </span>
        </div>
