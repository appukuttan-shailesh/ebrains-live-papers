  ...
  render() {
    return (
      <div>
        ...
        >
          <div className="title-solid-style" style={{ fontSize: 44 }}>Resources for developers</div>
          <div className="title-solid-style" style={{ fontSize: 32, color: "#00A595" }}>Access live papers in your own tools and workflows</div>
        </div>
