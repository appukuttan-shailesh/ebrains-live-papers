...
if (
  url.includes("https://humanbrainproject.github.io/hbp-bsp-live-papers/") ||
  ...
  ga_script.src =
    "https://humanbrainproject.github.io/hbp-bsp-live-papers/static/js/lp_prod_analytics.js";
} else if (
  url.includes("https://cnr-ibf-pa.github.io/hbp-bsp-live-papers-dev/")
) {
  console.log("Loading ga for bspg");
  ga_script_g.src = "https://www.googletagmanager.com/gtag/js?id=UA-91794319-4";
  ga_script.src =
    "https://cnr-ibf-pa.github.io/hbp-bsp-live-papers-dev/static/js/lp_dev_analytics.js";
} else {
